...
declare_id!("7ZrKbLU5nsU6Pyyj9TtVYT8WdrEbiCjeTD7C5Brfgcrf");
...
pub fn run_create_player(ctx: Context<CreatePlayer>) -> Result<()> {
    ...
    msg!("Hero has entered the game!");
    {
        ...
        spend_action_points(action_points_to_spend, &mut ctx.accounts.player_account, &ctx.accounts.player.to_account_info(), &ctx.accounts.system_program.to_account_info())?;
    }
